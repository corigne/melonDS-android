...
MelonDSAndroid::EmulatorConfiguration MelonDSAndroidConfiguration::buildEmulatorConfiguration(JNIEnv* env, jobject emulatorConfiguration) {
    ...
    jboolean syncRtcOnResume = env->GetBooleanField(emulatorConfiguration, env->GetFieldID(emulatorConfigurationClass, "syncRtcOnResume", "Z"));
    ...
    finalEmulatorConfiguration.syncRtcOnResume = syncRtcOnResume;
